    ...
    class SolverInstance:
        ...
        def notify_intermediate_solution_found(self, result: Result):
            try:
                ...
                res = requests.post(self.solution_manager_url + "/solutions", data=result_as_json, headers="Content-Type: application/json")
        ...
        def notify_optimal_solution(self, result: Result):
            try:
                ...
                requests.post(self.solution_manager_url + "/solutions", data=result_as_json, headers="Content-Type: application/json")
